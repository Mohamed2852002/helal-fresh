...
import 'package:yalla_now_delivery/common/models/response_model.dart';
import 'package:yalla_now_delivery/features/address/domain/models/record_location_body_model.dart';
...
class ProfileRepository implements ProfileRepositoryInterface {
  ...
  Future<void> recordWebSocketLocation(
    ...
    print(
        'dcsfvsfsvsvfvfs ${Get.find<SplashController>().configModel!.webSocketKey}');
    String uri =
    ...
    print('dcsfvsfsvsvfvfs $wsUrl');
    var channel =  WebSocketChannel.connect(wsUrl);

    channel.stream.listen(
      (message) {
        print('Received from WebSocket: $message'); // Handle response here
      },
      onError: (error) {
    ...
    print('recordWebSocketLocation ${jsonEncode(recordLocationBody)}');
